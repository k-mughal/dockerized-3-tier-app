...
output "public_instance_fe_ip" {
  value = aws_instance.public_instance_fe.public_ip
}

output "private_instance_be_ip" {
  value = aws_instance.private_instance_be.private_ip
